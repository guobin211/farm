...
## [0.0.12](https://github.com/guobin211/farm/compare/farmfe_compiler-v0.0.11...farmfe_compiler-v0.0.12) - 2024-09-04
...
- bundle import namespace name uniq ([#1696](https://github.com/guobin211/farm/pull/1696))
- single bundle ([#1653](https://github.com/guobin211/farm/pull/1653))

### Other
- *(refactor)* refactor stats and visualizer ([#1739](https://github.com/guobin211/farm/pull/1739))
- remove `query_string` when `emit_file` to `resource_map` in `plugin_static_assets` ([#1746](https://github.com/guobin211/farm/pull/1746))
